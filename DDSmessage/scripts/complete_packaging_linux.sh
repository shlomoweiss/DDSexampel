#!/bin/bash
# Linux Bash script for DDSmessage Conan packaging
...
if [ -z "$SO_FILE" ]; then
    echo "❌ libICD.so not found in build_linux/ or build/"
...
echo ""
echo "=========================================="
echo "SUCCESS: DDSmessage packaged!"
echo "=========================================="

echo ""
echo "What was accomplished:"
echo "PASSED: Verified existing Linux binaries (libICD.so)"
echo "PASSED: Created Conan package ddsmessage/1.0.0"
