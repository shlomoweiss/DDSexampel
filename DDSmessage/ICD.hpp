...
#ifndef FAST_DDS_GENERATED__ICD_PKG_ICD_HPP
#define FAST_DDS_GENERATED__ICD_PKG_ICD_HPP
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(ICD_SOURCE)
#define ICD_DllAPI __declspec( dllexport )
#else
#define ICD_DllAPI __declspec( dllimport )
#endif // ICD_SOURCE
#else
#define ICD_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
...
#endif // _FAST_DDS_GENERATED_ICD_PKG_ICD_HPP_
